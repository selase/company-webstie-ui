    ...
    <div class="hidden lg:flex  w-full   items-center ">
        ...
        <div class="flex items-center space-x-8 ml-20">
            ...
            <div class="group textOnScroll">
                ...
                <!-- Dropdown content -->
                <!-- <span class="hidden right-0 whitespace-nowrap ">
                            <svg width="70%" height="70%" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">

                                <path d="M50 15 L35 25 H65 L50 15" fill="white" stroke="black" stroke-opacity="0.08"
                ...
                <div
                    class="hidden group-hover:block  absolute ring-1 mt-[1.73rem] bg-white rounded ring-black/10 textOnScroll">

                    <a href="#" class="inline-block bg-red w-full  group-focus:block">
                        <div class="flex">
                            ...
                            <div>
                                <p>Startups</p>
                                <span>Where scales start</span>
                            </div>
                        </div>
                    </a>
                    <a href="#" class="inline-block bg-red w-full  group-focus:block textOnScroll">
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30"
                                viewBox="0 0 50 50">
                                <path
            ...
            <a href="#"
                class="hover:border-b-2 hover:border-blue-600 transition-colors duration-300 textOnScroll">Customers</a>
            <a href="#"
                class="hover:border-b-2 hover:border-blue-600 transition-colors duration-300 textOnScroll">Community</a>
            <!-- About us navigations -->
            <div>

                <button class="whitespace-nowrap flex items-center space-x-1 textOnScroll">
            ...
            <div>
                <button class="whitespace-nowrap flex items-center space-x-1 ">
                    <span class="font-sm textOnScroll">Resources</span>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 10L12 15L17 10" stroke="#333" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
